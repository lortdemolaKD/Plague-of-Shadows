...
namespace SavedSettings
{
    public class SettingsHelper : MonoBehaviour
    {
        ...
        [SerializeField] public static float ParticleMultiplier = 1f;
        [SerializeField] public static float ParticleLifeTimeMultiplier = 1f;
        [SerializeField] public static AudioMixer _MasterAudioMixer;
        [SerializeField] public const string MASTER_MIXER_STRING = "MasterMixer";
